...
from datasets import Molecule3DMaskingDataset, PredictionDataset, MoleculeGraphCLMaskingDataset, MoleculeDataset_graphcl
import warnings
...
if __name__ == '__main__':
    ...
    args.dataset = 'test_GEOM_3D_nmol100_nconf5_nupper1000'
    ...
    model_dict = torch.load('ablation_model/openpom_GraphCL_GNN_best_model.pth', map_location=device)
    ...
    with torch.no_grad():
        ...
        final_df.to_hdf('test_openpom_GraphCL_embedding_with_label.h5', key='df', mode='w')