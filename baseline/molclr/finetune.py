...
class FineTune(object):
    def __init__(self, dataset, config):
        ...
        dir_name = config['dataset']['target']
...
if __name__ == "__main__":
    ...
    # One's own dataset
    elif config['task_name'] in ['openpom_train_dataset_primary', "openpom_train_dataset_secondary", "openpom_train_dataset_third", "fmo_train_dataset_third", "fmo_train_dataset_primary", "fmo_train_dataset_secondary"]:
        print(f"Train your own dataset tasks:{config['task_name']}")
        config['dataset']['task'] = 'classification'
        config['dataset']['data_path'] = f"data/{config['task_name']}/{config['task_name']}.csv"
    ...
    for target in target_list:
        ...
        if isinstance(result, FineTune):
            print(f"{target}:Single data error！")
            shutil.rmtree(result.log_dir)
            continue
        else:
